  ...
  return (
    <div className="animate-fade-in-up">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-slate-400">Sign in to continue creating amazing ads</p>
      </div>
      ...
      <div className="rounded-3xl bg-slate-900/50 border border-white/10 backdrop-blur-xl p-8 shadow-2xl shadow-black/20">
        ...
        {/* Demo Mode Notice */}
        <div className="mt-6 p-4 rounded-2xl bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center flex-shrink-0">
              <Sparkles className="w-5 h-5 text-white" />
            </div>
            <div>
              <p className="text-sm font-medium text-white">Try Demo Mode</p>
              <p className="text-xs text-slate-400">
                Set DEMO_MODE=true in .env to explore without authentication
              </p>
            </div>
          </div>
        </div>
    ...
    <Suspense
      fallback={
        <div className="animate-pulse space-y-6">
          <div className="h-8 bg-slate-800/50 rounded-xl w-2/3 mx-auto" />
          <div className="h-4 bg-slate-800/50 rounded-lg w-1/2 mx-auto" />
